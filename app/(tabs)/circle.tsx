  ...
  return (
    ...
    >
      ...
      <View style={styles.legend}>
        <Text style={[typography.caption, styles.leg]}>Inner: Close Friends · Outer: Friends</Text>
      </View>
      <Pressable onPress={() => { setOpen(true); setDone(false); setPhone(''); }} style={styles.link}>
      ...
      <Modal visible={open} animationType="slide" transparent>
        <View style={styles.sheetBackdrop}>
          <View style={styles.sheet}>
            <Text style={[typography.subheading, { color: tokens.text, marginBottom: spacing.sm }]}>
              Add friend
            </Text>
            <TextInput
              style={styles.input}
